...
void BloomEffect::PrepareTextures(sf::Vector2u size)
{
	...
	{
		static_cast<void>(m_brightness_texture.resize(size));
		static_cast<void>(m_brightness_texture.setSmooth(true));

		static_cast<void>(m_firstpass_textures[0].resize({ size.x / 2, size.y / 2 }));
		m_firstpass_textures[0].setSmooth(true);
		static_cast<void>(m_firstpass_textures[1].resize({ size.x / 2, size.y / 2 }));
		m_firstpass_textures[1].setSmooth(true);

		static_cast<void>(m_secondpass_textures[0].resize({ size.x / 4, size.y / 4 }));
		m_secondpass_textures[0].setSmooth(true);
		static_cast<void>(m_secondpass_textures[1].resize({ size.x / 4, size.y / 4 }));
